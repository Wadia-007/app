...
class editorial(ListView):
    model = Post
    context_object_name = "posts"
    template_name = "blog/editorial.html"
    queryset = Post.objects.filter(status="P")
...
class advertise(ListView):
    model = Post
    context_object_name = "posts"
    template_name = "blog/advertise.html"
    queryset = Post.objects.filter(status="P")
...
def postdetail(request,slug):
    ...
    return render(request,f'blog/post_detail_{post.author}.html',{'post':post})
